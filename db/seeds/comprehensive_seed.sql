-- =====================================================
-- COMPREHENSIVE SEED DATA FOR KINCARE
...
-- DELETE FROM vendors;
-- DELETE FROM asp_net_users WHERE facility_id IS NOT NULL;
...
-- =====================================================
INSERT INTO organizations (id, name, plan_tier, is_active, billing_email, broker_enabled, created_at)
VALUES
...
INSERT INTO facilities (id, organization_id, name, address, timezone, uber_health_enabled, is_active, created_at)
VALUES
...
-- =====================================================
INSERT INTO residents (id, facility_id, first_name, last_name, needs_wheelchair, needs_oxygen, needs_stretcher, needs_walker, driver_notes, is_active, created_at)
VALUES
...
-- =====================================================
INSERT INTO vendors (id, facility_id, name, phone_number, vendor_type, dispatch_method, capability_tier, is_active, created_at)
VALUES
...
INSERT INTO rides (id, facility_id, organization_id, resident_id, vendor_id, status, dispatch_channel, pickup_time, pickup_address, destination_address, tracking_token, created_at)
VALUES
...
INSERT INTO rides (id, facility_id, organization_id, resident_id, vendor_id, status, dispatch_channel, pickup_time, pickup_address, destination_address, tracking_token, last_known_lat, last_known_lng, last_location_at, created_at)
VALUES
...
INSERT INTO rides (id, facility_id, organization_id, resident_id, vendor_id, status, dispatch_channel, pickup_time, pickup_address, destination_address, created_at)
VALUES
...
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd01', NULL, 0, 'system', 'Ride dispatched via SMS to Valley Medical Transport', NOW() - INTERVAL '3 hours'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd01', 0, 1, 'vendor_sms', 'Vendor confirmed via SMS reply - Driver: Mike Johnson', NOW() - INTERVAL '2 hours 45 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 2 (Robert - EnRoute)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd02', NULL, 0, 'system', 'Ride dispatched via SMS to Detroit NEMT', NOW() - INTERVAL '1 hour'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd02', 0, 1, 'vendor_sms', 'Vendor confirmed - Driver: Sarah Williams', NOW() - INTERVAL '50 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd02', 1, 3, 'vendor_sms', 'Driver on the way to pickup', NOW() - INTERVAL '15 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 3 (Dorothy - Arrived)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd03', NULL, 0, 'system', 'Ride dispatched via SMS to City Ambulatory', NOW() - INTERVAL '45 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd03', 0, 1, 'vendor_sms', 'Confirmed by driver Tom Harris', NOW() - INTERVAL '40 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd03', 1, 3, 'tracking_page', 'Driver marked on the way via GPS tracker', NOW() - INTERVAL '20 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd03', 3, 4, 'tracking_page', 'Arrived at destination - GPS confirmed', NOW() - INTERVAL '2 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 4 (James - Dispatched)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd04', NULL, 0, 'system', 'Ride dispatched via SMS to Premier Wheelchair - Special needs: Wheelchair + Oxygen', NOW() - INTERVAL '15 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 5 (Eleanor - Confirmed)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd05', NULL, 0, 'system', 'Ride dispatched via SMS to Quick Ride Taxi', NOW() - INTERVAL '30 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd05', 0, 1, 'vendor_sms', 'Driver David Kim confirmed pickup', NOW() - INTERVAL '25 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 6 (William - Dropped)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd06', NULL, 0, 'system', 'Ride dispatched - Medical stretcher transport from hospital', NOW() - INTERVAL '3 hours'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd06', 0, 1, 'vendor_sms', 'Confirmed by Valley Medical - Stretcher van assigned', NOW() - INTERVAL '2 hours 50 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd06', 1, 3, 'vendor_sms', 'Driver en route to hospital pickup', NOW() - INTERVAL '1 hour 30 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd06', 3, 4, 'vendor_sms', 'Arrived at hospital - loading patient', NOW() - INTERVAL '45 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd06', 4, 5, 'vendor_sms', 'Resident safely returned to facility', NOW() - INTERVAL '10 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 7 (Linda - EnRoute)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd07', NULL, 0, 'system', 'Ride dispatched via SMS to City Ambulatory', NOW() - INTERVAL '25 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd07', 0, 1, 'vendor_sms', 'Driver Lisa Chen confirmed', NOW() - INTERVAL '22 minutes'),
  (gen_random_uuid(), 'dddddddd-ddbb-dddd-dddd-dddddddddd07', 1, 3, 'tracking_page', 'On the way - GPS active', NOW() - INTERVAL '10 minutes')
ON CONFLICT DO NOTHING;

-- Events for Ride 8 (Henry - Confirmed)
INSERT INTO ride_events (id, ride_id, from_status, to_status, triggered_by, notes, occurred_at)
VALUES
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd08', NULL, 0, 'system', 'Ride dispatched to Premier Wheelchair - Manual wheelchair transport', NOW() - INTERVAL '20 minutes'),
  (gen_random_uuid(), 'dddddddd-dddd-dddd-dddd-dddddddddd08', 0, 1, 'vendor_sms', 'Confirmed - wheelchair-accessible van ready', NOW() - INTERVAL '18 minutes')
ON CONFLICT DO NOTHING;
